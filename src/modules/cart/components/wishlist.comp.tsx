    ...
    <div className="relative mt-10 ">
      <div className="container mx-auto  border-t-2 border-gray-300 py-20">
        <div className="flex justify-between items-center">
          <h1 className="text-2xl font-semibold mb-10">Wishlist (6)</h1>
          <div className="flex justify-between items-center gradient-text cursor-pointer">
            See All
            <ArrowRightIcon stroke="#FDA106" />
          </div>
        </div>
