    ...
    <div className="bg-[#032F21] py-12">
      <div className="container mx-auto px-6 mt-10">
        ...
        <div className="relative">
          {/*==== Left Arrow ====*/}
          <button className="absolute -left-2 top-1/2 -translate-y-1/2 -translate-x-4 z-10 w-12 h-12 bg-secondary-color rounded-xl shadow-lg flex items-center justify-center transition-colors">
            <ArrowLeftIcon />
          </button>
          ...
          {/*==== Right Arrow ====*/}
          <button className="absolute -right-2 top-1/2 -translate-y-1/2 translate-x-4 z-10 w-12 h-12 bg-secondary-color rounded-xl shadow-lg flex items-center justify-center transition-colors">
            <ArrowRightIcon />
          </button>
        </div>
