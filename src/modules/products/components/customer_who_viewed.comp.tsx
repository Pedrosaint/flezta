...
const CustomerWhoViewedComp = () => {
  ...
  return (
    <div className="relative mt-30 py-20 border-t-2 border-gray-300">
      ...
      {/*==== Left Arrow ====*/}
      <button className="absolute -left-2 top-1/2 -translate-y-1/2 -translate-x-4 z-10 w-12 h-12 border border-[#003625] bg-secondary-color rounded-xl shadow-lg flex items-center justify-center transition-colors">
        <ArrowLeftIcon />
      </button>
      ...
      {/*==== Right Arrow ====*/}
      <button className="absolute -right-2 top-1/2 -translate-y-1/2 translate-x-4 z-10 w-12 h-12 border border-[#003625] bg-secondary-color rounded-xl shadow-lg flex items-center justify-center transition-colors">
        <ArrowRightIcon />
      </button>
    </div>
  );
...
export default CustomerWhoViewedComp;
