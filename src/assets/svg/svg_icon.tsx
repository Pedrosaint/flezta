...
export interface CustomSVGIconProps extends React.SVGProps<SVGSVGElement> {
  stroke?: string;
  width?: string | number;
...
export const GoodIcon = ({ width = 44, height = 44, ...props }: CustomSVGIconProps) => (
  <svg
    width={width}
    height={height}
    viewBox="0 0 44 44"
...
export const ArrowUpIcon = ({ width = 24, height = 24 }: CustomSVGIconProps) => (
  <svg
    width={width}
    height={height}
    viewBox="0 0 24 24"
  ...
  >
    ...
    <defs>
      ...
      >
        <stop stopColor="#E26E00" />
        <stop offset="1" stopColor="#FDA106" />
      </linearGradient>
      <linearGradient
...
export const AddToCartIcon = ({ width = 24, height = 24 }: CustomSVGIconProps) => (
  <svg
    width={width}
    height={height}
    viewBox="0 0 24 24"
...
export const NegotiateIcon = ({ width = 24, height = 24 }: CustomSVGIconProps) => (
  <svg
    width={width}
    height={height}
    viewBox="0 0 24 24"
...
export const AppleIcon = ({ ...props }: CustomSVGIconProps) => (
  <svg className="w-10 h-10" viewBox="0 0 24 24" fill="currentColor" {...props}>
...
export const HomeIcon = ({ width = 24, height = 24 }: CustomSVGIconProps) => (
  <svg
    width={width}
    height={height}
    viewBox="0 0 24 24"
...
export const ChatIcon2 = ({ ...props }: CustomSVGIconProps) => (
  <svg
    width="24"
    height="24"
    viewBox="0 0 24 24"
...
export const ChatIcon3 = ({ ...props }: CustomSVGIconProps) => (<svg
  width="24"
  height="24"
  viewBox="0 0 24 24"
  fill="none"
...
export const DeleteIcon2 = ({ ...props }: CustomSVGIconProps) => (<svg
  width="24"
  height="24"
  viewBox="0 0 24 24"
  fill="none"
...
export const DefaultIcon = ({ ...props }: CustomSVGIconProps) => (<svg
  width="16"
  height="16"
  viewBox="0 0 16 16"
  fill="none"
...
export const DateIcon = ({ width = 20, height = 20, stroke = "#0C0F16", ...props }: CustomSVGIconProps) => (<svg
  width={width}
  height={height}
  viewBox="0 0 20 20"
  fill="none"
...
export const GameIcon = ({ stroke = "#4B5563", width = 24, height = 24, ...props }: CustomSVGIconProps) => (<svg
  width={width}
  height={height}
  viewBox="0 0 24 24"
  fill="none"
...
export const LaptopIcon = ({ stroke = "#4B5563", width = 24, height = 24, ...props }: CustomSVGIconProps) => (<svg
  width={width}
  height={height}
  viewBox="0 0 24 24"
  fill="none"
...
export const HeadphoneIcon = ({ stroke = "#4B5563", width = 24, height = 24, ...props }: CustomSVGIconProps) => (<svg
  width={width}
  height={height}
  viewBox="0 0 24 24"
  fill="none"
...
export const CameraIcon = ({ stroke = "#4B5563", width = 24, height = 24, ...props }: CustomSVGIconProps) => (<svg
  width={width}
  height={height}
  viewBox="0 0 24 24"
  fill="none"
...
export const TVIcon = ({ stroke = "#4B5563", width = 24, height = 24, ...props }: CustomSVGIconProps) => (<svg
  width={width}
  height={height}
  viewBox="0 0 24 24"
  fill="none"
...
export const HairIcon = ({ stroke = "#4B5563", width = 24, height = 24, ...props }: CustomSVGIconProps) => (<svg
  width={width}
  height={height}
  viewBox="0 0 24 24"
  fill="none"
...
export const ArrowRight = ({ stroke = "#0C0F16", width = 8, height = 14, ...props }: CustomSVGIconProps) => (<svg
  width={width}
  height={height}
  viewBox="0 0 8 14"
  fill="none"
...
export const WalletIcon = ({ stroke = "#0C0F16", width = 32, height = 32, ...props }: CustomSVGIconProps) => (<svg
  width={width}
  height={height}
  viewBox="0 0 32 32"
  fill="none"
...
export const OrderIcon = ({ stroke = "#0C0F16", width = 24, height = 24, ...props }: CustomSVGIconProps) => (
  <svg width={width} height={height} viewBox="0 0 24 24" fill="none" {...props} xmlns="http://www.w3.org/2000/svg">
    <path d="M11 6H21" stroke={stroke} stroke-width="1.5" stroke-linecap="round" />
    <path d="M11 12H21" stroke={stroke} stroke-width="1.5" stroke-linecap="round" />
    <path d="M11 18H21" stroke={stroke} stroke-width="1.5" stroke-linecap="round" />
    <path d="M3 7.39286C3 7.39286 4 8.04466 4.5 9C4.5 9 6 5.25 8 4" stroke={stroke} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
    <path d="M3 18.3929C3 18.3929 4 19.0447 4.5 20C4.5 20 6 16.25 8 15" stroke={stroke} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
  </svg>
);

export const LogoutIcon = ({ stroke = "#0C0F16", width = 24, height = 24, ...props }: CustomSVGIconProps) => (
  <svg width={width} height={height} viewBox="0 0 24 24" fill="none" {...props} xmlns="http://www.w3.org/2000/svg">
    <path d="M8.00002 8C8.00002 7.42459 8.00002 7.17765 8.04465 6.92457C8.21993 5.93047 8.89355 5.09255 9.83302 4.70001C10.0723 4.60003 10.3559 4.53526 10.9232 4.40573L13.6508 3.78286C17.0405 3.00882 18.7353 2.6218 19.8677 3.51317C21 4.40454 21 6.1257 21 9.56803V14.432C21 17.8743 21 19.5955 19.8676 20.4868C18.7353 21.3782 17.0405 20.9912 13.6508 20.2171L10.9232 19.5943C10.3559 19.4647 10.0723 19.4 9.833 19.3C8.89353 18.9074 8.21991 18.0695 8.04462 17.0754C8 16.8224 8 16.5754 8 16" stroke={stroke} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M13 9C13 9 16 11.2095 16 12C16 12.7906 13 15 13 15M15.5 12H3" stroke={stroke} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);

export const SettingsIcon = ({ stroke = "#0C0F16", width = 24, height = 24, ...props }: CustomSVGIconProps) => (
  <svg width={width} height={height} viewBox="0 0 24 24" fill="none" {...props} xmlns="http://www.w3.org/2000/svg">
    <path d="M21.3175 7.14139L20.8239 6.28479C20.4506 5.63696 20.264 5.31305 19.9464 5.18388C19.6288 5.05472 19.2696 5.15664 18.5513 5.36048L17.3311 5.70418C16.8725 5.80994 16.3913 5.74994 15.9726 5.53479L15.6357 5.34042C15.2766 5.11043 15.0004 4.77133 14.8475 4.37274L14.5136 3.37536C14.294 2.71534 14.1842 2.38533 13.9228 2.19657C13.6615 2.00781 13.3143 2.00781 12.6199 2.00781H11.5051C10.8108 2.00781 10.4636 2.00781 10.2022 2.19657C9.94085 2.38533 9.83106 2.71534 9.61149 3.37536L9.27753 4.37274C9.12465 4.77133 8.84845 5.11043 8.48937 5.34042L8.15249 5.53479C7.73374 5.74994 7.25259 5.80994 6.79398 5.70418L5.57375 5.36048C4.85541 5.15664 4.49625 5.05472 4.17867 5.18388C3.86109 5.31305 3.67445 5.63696 3.30115 6.28479L2.80757 7.14139C2.45766 7.74864 2.2827 8.05227 2.31666 8.37549C2.35061 8.69871 2.58483 8.95918 3.05326 9.48012L4.0843 10.6328C4.3363 10.9518 4.51521 11.5078 4.51521 12.0077C4.51521 12.5078 4.33636 13.0636 4.08433 13.3827L3.05326 14.5354C2.58483 15.0564 2.35062 15.3168 2.31666 15.6401C2.2827 15.9633 2.45766 16.2669 2.80757 16.8741L3.30114 17.7307C3.67443 18.3785 3.86109 18.7025 4.17867 18.8316C4.49625 18.9608 4.85542 18.8589 5.57377 18.655L6.79394 18.3113C7.25263 18.2055 7.73387 18.2656 8.15267 18.4808L8.4895 18.6752C8.84851 18.9052 9.12464 19.2442 9.2775 19.6428L9.61149 20.6403C9.83106 21.3003 9.94085 21.6303 10.2022 21.8191C10.4636 22.0078 10.8108 22.0078 11.5051 22.0078H12.6199C13.3143 22.0078 13.6615 22.0078 13.9228 21.8191C14.1842 21.6303 14.294 21.3003 14.5136 20.6403L14.8476 19.6428C15.0004 19.2442 15.2765 18.9052 15.6356 18.6752L15.9724 18.4808C16.3912 18.2656 16.8724 18.2055 17.3311 18.3113L18.5513 18.655C19.2696 18.8589 19.6288 18.9608 19.9464 18.8316C20.264 18.7025 20.4506 18.3785 20.8239 17.7307L21.3175 16.8741C21.6674 16.2669 21.8423 15.9633 21.8084 15.6401C21.7744 15.3168 21.5402 15.0564 21.0718 14.5354L20.0407 13.3827C19.7887 13.0636 19.6098 12.5078 19.6098 12.0077C19.6098 11.5078 19.7888 10.9518 20.0407 10.6328L21.0718 9.48012C21.5402 8.95918 21.7744 8.69871 21.8084 8.37549C21.8423 8.05227 21.6674 7.74864 21.3175 7.14139Z" stroke={stroke} stroke-width="1.5" stroke-linecap="round" />
    <path d="M15.5195 12C15.5195 13.933 13.9525 15.5 12.0195 15.5C10.0865 15.5 8.51953 13.933 8.51953 12C8.51953 10.067 10.0865 8.5 12.0195 8.5C13.9525 8.5 15.5195 10.067 15.5195 12Z" stroke={stroke} stroke-width="1.5" />
  </svg>
);

export const Love = ({ stroke = "#0C0F16", width = 24, height = 24, ...props }: CustomSVGIconProps) => (
  <svg width={width} height={height} viewBox="0 0 24 24" fill="none" {...props} xmlns="http://www.w3.org/2000/svg">
    <path d="M10.4107 19.9677C7.58942 17.858 2 13.0348 2 8.69444C2 5.82563 4.10526 3.5 7 3.5C8.5 3.5 10 4 12 6C14 4 15.5 3.5 17 3.5C19.8947 3.5 22 5.82563 22 8.69444C22 13.0348 16.4106 17.858 13.5893 19.9677C12.6399 20.6776 11.3601 20.6776 10.4107 19.9677Z" stroke={stroke} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
  </svg>

);

export const Good = ({ stroke = "white", width = 10, height = 9, ...props }: CustomSVGIconProps) => (
  <svg width={width} height={height} viewBox="0 0 10 9" fill="none" {...props} xmlns="http://www.w3.org/2000/svg">
    <path d="M0.75 5.5C0.75 5.5 2.35 6.4125 3.15 7.75C3.15 7.75 5.55 2.5 8.75 0.75" stroke={stroke} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
  </svg>

);

export const EditIcon = ({ stroke = "#0C0F16", width = 24, height = 24, ...props }: CustomSVGIconProps) => (
  <svg width={width} height={height} viewBox="0 0 24 24" fill="none" {...props} xmlns="http://www.w3.org/2000/svg">
    <path d="M16.4249 4.60509L17.4149 3.6151C18.2351 2.79497 19.5648 2.79497 20.3849 3.6151C21.205 4.43524 21.205 5.76493 20.3849 6.58507L19.3949 7.57506M16.4249 4.60509L9.76558 11.2644C9.25807 11.772 8.89804 12.4078 8.72397 13.1041L8 16L10.8959 15.276C11.5922 15.102 12.228 14.7419 12.7356 14.2344L19.3949 7.57506M16.4249 4.60509L19.3949 7.57506" stroke={stroke} stroke-width="1.5" stroke-linejoin="round" />
    <path d="M18.9999 13.5C18.9999 16.7875 18.9999 18.4312 18.092 19.5376C17.9258 19.7401 17.7401 19.9258 17.5375 20.092C16.4312 21 14.7874 21 11.4999 21H11C7.22876 21 5.34316 21 4.17159 19.8284C3.00003 18.6569 3 16.7712 3 13V12.5C3 9.21252 3 7.56879 3.90794 6.46244C4.07417 6.2599 4.2599 6.07417 4.46244 5.90794C5.56879 5 7.21252 5 10.5 5" stroke={stroke} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
  </svg>


);

export const Delete = ({ stroke = "#D24545", width = 24, height = 24, ...props }: CustomSVGIconProps) => (
  <svg width={width} height={height} viewBox="0 0 24 24" fill="none" {...props} xmlns="http://www.w3.org/2000/svg">
    <path d="M19.5 5.5L18.8803 15.5251C18.7219 18.0864 18.6428 19.3671 18.0008 20.2879C17.6833 20.7431 17.2747 21.1273 16.8007 21.416C15.8421 22 14.559 22 11.9927 22C9.42312 22 8.1383 22 7.17905 21.4149C6.7048 21.1257 6.296 20.7408 5.97868 20.2848C5.33688 19.3626 5.25945 18.0801 5.10461 15.5152L4.5 5.5" stroke={stroke} stroke-width="1.5" stroke-linecap="round" />
    <path d="M3 5.5H21M16.0557 5.5L15.3731 4.09173C14.9196 3.15626 14.6928 2.68852 14.3017 2.39681C14.215 2.3321 14.1231 2.27454 14.027 2.2247C13.5939 2 13.0741 2 12.0345 2C10.9688 2 10.436 2 9.99568 2.23412C9.8981 2.28601 9.80498 2.3459 9.71729 2.41317C9.32164 2.7167 9.10063 3.20155 8.65861 4.17126L8.05292 5.5" stroke={stroke} stroke-width="1.5" stroke-linecap="round" />
    <path d="M9.5 16.5V10.5" stroke={stroke} stroke-width="1.5" stroke-linecap="round" />
    <path d="M14.5 16.5V10.5" stroke={stroke} stroke-width="1.5" stroke-linecap="round" />
  </svg>
);

export const ErrorIcon = () => (
  <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M25.5286 38.5H18.471C9.9819 38.5 5.73735 38.5 4.17317 35.7388C2.60899 32.9778 4.78 29.3176 9.12203 21.9973L12.6509 16.0478C16.8218 9.01593 18.9072 5.5 21.9998 5.5C25.0925 5.5 27.1779 9.01591 31.3487 16.0478L34.8777 21.9973C39.2196 29.3176 41.3906 32.9778 39.8264 35.7388C38.2622 38.5 34.0177 38.5 25.5286 38.5Z" stroke="url(#paint0_linear_1485_2743)" stroke-width="2.75" stroke-linecap="round" stroke-linejoin="round" />
    <path d="M22 31.167V22.917" stroke="url(#paint1_linear_1485_2743)" stroke-width="2.75" stroke-linecap="round" stroke-linejoin="round" />
    <path d="M22 16.4968V16.4785" stroke="url(#paint2_linear_1485_2743)" stroke-width="3.3" stroke-linecap="round" stroke-linejoin="round" />
    <defs>
      <linearGradient id="paint0_linear_1485_2743" x1="3.6665" y1="22" x2="40.3331" y2="22" gradientUnits="userSpaceOnUse">
        <stop stop-color="#E26E00" />
        <stop offset="1" stop-color="#FDA106" />
      </linearGradient>
      <linearGradient id="paint1_linear_1485_2743" x1="22" y1="27.042" x2="23" y2="27.042" gradientUnits="userSpaceOnUse">
        <stop stop-color="#E26E00" />
        <stop offset="1" stop-color="#FDA106" />
      </linearGradient>
      <linearGradient id="paint2_linear_1485_2743" x1="22" y1="16.4877" x2="23" y2="16.4877" gradientUnits="userSpaceOnUse">
        <stop stop-color="#E26E00" />
        <stop offset="1" stop-color="#FDA106" />
      </linearGradient>
    </defs>
...
export const ShieldIcon = ({ stroke = "#077D58", width = 24, height = 24, ...props }: CustomSVGIconProps) => (
  <svg width={width} height={height} viewBox="0 0 24 24" fill="none" {...props} xmlns="http://www.w3.org/2000/svg">
    <path d="M18.7088 3.49534C16.8165 2.55382 14.5009 2 12 2C9.4991 2 7.1835 2.55382 5.29116 3.49534C4.36318 3.95706 3.89919 4.18792 3.4496 4.91378C3 5.63965 3 6.34248 3 7.74814V11.2371C3 16.9205 7.54236 20.0804 10.173 21.4338C10.9067 21.8113 11.2735 22 12 22C12.7265 22 13.0933 21.8113 13.8269 21.4338C16.4576 20.0804 21 16.9205 21 11.2371V7.74814C21 6.34249 21 5.63966 20.5504 4.91378C20.1008 4.18791 19.6368 3.95706 18.7088 3.49534Z" stroke={stroke} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
    <path d="M9 11.5C9 11.5 10.4079 11.7519 11 13.5C11 13.5 12.5 10.5 15 9.5" stroke={stroke} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
  </svg>
